...
def display_line_graph(start_date, end_date):
    ...
    ax1.plot([i for i in range(0, 24)], get_avgAccident(
        start_date, end_date), color="blue", linewidth=2.5, linestyle="-")
    ...
    ax2.set(
        title=f'The Number of Accidents For Each Region from {start_date} to {end_date}', xlabel='Region', ylabel='Number of Accidents')
    ...
    ax3.plot([i for i in range(0, 12)], [i for i in range(12, 0, -1)],
