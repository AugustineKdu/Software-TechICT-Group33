...
# graph search frame
graph_search_frame = tk.Frame(root)
...
title_label = tk.Label(graph_search_frame, text="Search For Graph", font=("Arial", 18, "bold"))
title_label.grid(row=0, column=4, columnspan=4, padx=10, pady=10, sticky='w')

start_date_label = tk.Label(graph_search_frame, text="Start Date:")
...
end_date_label = tk.Label(graph_search_frame, text="End Date:")
...
date_range_label = tk.Label(graph_search_frame, text=f"Selectable Date Range: {min_date} to {max_date}", font=('Arial', 9), fg='grey')
date_range_label.grid(row=0, column=0, columnspan=4, pady=10, sticky='s')

alcohol_related_label = tk.Label(graph_search_frame, text="Alcohol Related:")
alcohol_related_label.grid(row=1, column=4, padx=(10, 0), pady=10, sticky='e')
alcohol_related_options = ["All", "Yes", "No"]
alcohol_related_combobox = ttk.Combobox(graph_search_frame, values=alcohol_related_options, state="readonly")
alcohol_related_combobox.set("All")
alcohol_related_combobox.grid(row=1, column=5, padx=(0, 10), pady=10, sticky='w')

category_label = tk.Label(graph_search_frame, text="Category:")
category_label.grid(row=1, column=6, padx=(10, 0), pady=10, sticky='e')
category_options = ["ACCIDENT_TYPE", "SEVERITY", "REGION_NAME"]
category_combobox = ttk.Combobox(graph_search_frame, values=category_options, state="readonly")
...
graph_search_button = tk.Button(graph_search_frame, text="Search", command=graph_search)
...
title_label = tk.Label(table_search_frame, text="Search For Table", font=("Arial", 18, "bold"))
title_label.grid(row=0, column=4, columnspan=4, padx=10, pady=10, sticky='w')

table_start_date_label = tk.Label(table_search_frame, text="Start Date:")
...
table_end_date_label = tk.Label(table_search_frame, text="End Date:")
...
keyword_label = tk.Label(table_search_frame, text="Type a keyword for accident type:")
...
date_range_label = tk.Label(table_search_frame, text=f"Selectable Date Range: {min_date} to {max_date}", font=('Arial', 9), fg='grey')
...
table_search_button = tk.Button(table_search_frame, text="Search", command=table_search)
